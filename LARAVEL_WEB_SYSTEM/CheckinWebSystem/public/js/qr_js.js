...
!(function () {
    ...
    (t.prototype = {
        ...
        (h.createData = function (e, t, r) {
            for (
                var n = c.getRSBlocks(e, t), a = new s(), i = 0;
                i < r.length;
                i++
            ) {
                var o = r[i];
        ...
        var i = {
            ...
            m = {
                ...
                getBCHTypeInfo: function (e) {
                    for (
                        var t = e << 10;
                        0 <= m.getBCHDigit(t) - m.getBCHDigit(m.G15);
                ...
                getBCHTypeNumber: function (e) {
                    for (
                        var t = e << 12;
                        0 <= m.getBCHDigit(t) - m.getBCHDigit(m.G18);
    ...
    (this._br = o),
        ...
        (this._aq = function () {
            ...
            return (
                ...
                t._bq(9, 6, e - 17, 1),
                6 < this._bs &&
                    (t._bq(e - 11, 0, 3, 6), t._bq(0, e - 11, 6, 3)),
                t
            );
        }),
        (this._bu = function (e) {
...
function _cl(e) {
    ...
    (this._au = e),
        ...
        (this._cm = function () {
            ...
            for (
                var n = this._au.Dimension, e = 0, a = n - 8, t = n - 1;
                a <= t;
                t--
            )
                e = this._dk(t, 8, e);
        ...
        (this._cq = function () {
            ...
            if (
                ((this._cp = _a3._aw(r)), null != this._cp && this._cp._cr == e)
            )
                return this._cp;
            r = 0;
            for (i = 5; 0 <= i; i--)
            ...
            for (var n = t.length, a = new Array(n), i = 0; i < n; i++) {
                for (var o = this._fa.inverse(t[i]), _ = 1, h = 0; h < n; h++)
                    i != h &&
                        (_ = this._fa.multiply(
                            _,
                            _az._bd(1, this._fa.multiply(t[h], o))
                        ));
                (a[i] = this._fa.multiply(
                    e.evaluateAt(o),
                    this._fa.inverse(_)
                )),
        ...
        if (0 == arguments.length)
            return (
                (r = qrcode.canvas_qr2
                    ...
                    : (t = document.getElementById("qr-canvas")).getContext(
                          "2d"
                      )),
                (qrcode.width = t.width),
                (qrcode.height = t.height),
                (qrcode.imagedata = r.getImageData(
                    0,
                    0,
                    qrcode.width,
                    qrcode.height
        ...
        (i.crossOrigin = "Anonymous"),
            (i.onload = function () {
                ...
                i.width * i.height > qrcode.maxImgSize &&
                    (e =
                        (t = i.width / i.height) *
                        (a = Math.sqrt(qrcode.maxImgSize / t))),
                    (r.width = e),
                    (r.height = a),
                ...
                for (var a = 0; a < qrcode.width; a++) {
                    ...
                    (qrcode.imagedata.data[i] = (r[a + n * qrcode.width], 0)),
                        (qrcode.imagedata.data[i + 1] =
                            (r[a + n * qrcode.width], 0)),
                        (qrcode.imagedata.data[i + 2] = r[a + n * qrcode.width]
                            ? 255
                            : 0);
                }
            ...
            for (n = 0; n < o.bits.Height; n++)
                for (a = 0; a < o.bits.Width; a++) {
                    ...
                    (qrcode.imagedata.data[i] = (o.bits._ds(a, n), 0)),
                        ...
                        (qrcode.imagedata.data[i + 2] = o.bits._ds(a, n)
                            ? 255
                            : 0);
                }
            e.putImageData(qrcode.imagedata, 0, 0);
...
function _cc() {
    (this.image = null),
        ...
        (this._ej = function (e, t, r, n) {
            ...
            if (o[4] >= r) return NaN;
            e = o[0] + o[1] + o[2] + o[3] + o[4];
            return !(5 * Math.abs(e - n) >= n) && this._ao(o)
                ? this._an(o, _)
                : NaN;
        }),
        (this._cu = function (e, t, r) {
            ...
            if (
                isNaN(i) ||
                ((a = this._ej(Math.floor(a), Math.floor(i), e[2], n)),
                isNaN(a))
            )
                return !1;
            for (
                var o = n / 7, _ = !1, h = this._cv.length, s = 0;
                s < h;
                s++
            ) {
                var c = this._cv[s];
                ...
                if (n.Count >= _eg) {
                    if (null != t)
                        return (
                            (this._ge = !0),
                            Math.floor(
                                (Math.abs(t.X - n.X) - Math.abs(t.Y - n.Y)) / 2
                            )
                        );
                    t = n;
                }
                ...
                for (var h, s = 0; _ < r; ) {
                    if (c[_ + o * qrcode.width])
                        if (1 == s) a[s]++;
                            ...
                            if (this._ao(a))
                                if (null != (h = this._cu(a, o, _))) return h;
...
function QRCodeDataBlockReader(e, t, r) {
    (this._ed = 0),
        ...
        (this.NextMode = function () {
            return this._ed > this.blocks.length - this._en - 2
                ? 0
                : this._gd(4);
        }),
