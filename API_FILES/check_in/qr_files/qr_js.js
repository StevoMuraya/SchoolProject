...
!(function () {
  ...
  function n() {
    ...
    return (
      /android/i.test(t) &&
        ((e = !0),
        (t = t.toString().match(/android ([0-9]\.[0-9])/i)) &&
          t[1] &&
          (e = parseFloat(t[1]))),
      e
    );
  ...
  function r(e, t) {
    ...
    if (y.length < n) throw new Error("Too long data");
    return n;
  }
  (t.prototype = {
    ...
    (h.createData = function (e, t, r) {
      ...
      for (var _ = 0, i = 0; i < n.length; i++) _ += n[i].dataCount;
      if (a.getLengthInBits() > 8 * _)
        throw new Error(
          "code length overflow. (" + a.getLengthInBits() + ">" + 8 * _ + ")"
        );
      for (
        a.getLengthInBits() + 4 <= 8 * _ && a.put(0, 4);
      ...
      for (
        ...
        !(
          ...
          (a.put(h.PAD0, 8), a.getLengthInBits() >= 8 * _)
        );
    ...
    (h.createBytes = function (e, t) {
      for (
        ...
        var h = t[_].dataCount,
          ...
          a = Math.max(a, s);
        i[_] = new Array(h);
        for (var c = 0; c < i[_].length; c++) i[_][c] = 255 & e.buffer[c + r];
        r += h;
      ...
      for (var f = 0, c = 0; c < t.length; c++) f += t[c].totalCount;
      for (var u = new Array(f), l = 0, c = 0; c < n; c++)
        for (_ = 0; _ < t.length; _++) c < i[_].length && (u[l++] = i[_][c]);
      for (c = 0; c < a; c++)
        for (_ = 0; _ < t.length; _++) c < o[_].length && (u[l++] = o[_][c]);
      return u;
    });
  for (
    var i = {
  ...
  for (e = 8; e < 256; e++)
    p.EXP_TABLE[e] =
      ...
      p.EXP_TABLE[e - 6] ^
      p.EXP_TABLE[e - 8];
  for (e = 0; e < 255; e++) p.LOG_TABLE[p.EXP_TABLE[e]] = e;
  (g.prototype = {
    get: function (e) {
      return this.num[e];
    },
    ...
    mod: function (e) {
      ...
      for (
        var t = p.glog(this.get(0)) - p.glog(e.get(0)),
        ...
        r[n] = this.get(n);
      for (n = 0; n < e.getLength(); n++) r[n] ^= p.gexp(p.glog(e.get(n)) + t);
    ...
    (c.getRSBlocks = function (e, t) {
      ...
      for (var n = r.length / 3, a = [], i = 0; i < n; i++)
        for (
          var o = r[3 * i + 0], _ = r[3 * i + 1], h = r[3 * i + 2], s = 0;
          s < o;
          s++
        )
          a.push(new c(_, h));
    ...
    b =
      ((C.prototype.draw = function (e) {
        function t(e, t) {
          ...
          for (r in t) t.hasOwnProperty(r) && n.setAttribute(r, t[r]);
          return n;
        }
        var r = this._htOption,
          n = this._el,
          a = e.getModuleCount();
        Math.floor(r.width / a), Math.floor(r.height / a), this.clear();
        var i = t("svg", {
      ...
      "svg" === document.documentElement.tagName.toLowerCase()
        ...
        ? (function () {
            ...
            function t(e, t) {
              var r = this;
              if (
                ((r._fFail = t), (r._fSuccess = e), null === r._bSupportDataURI)
              ) {
              ...
              for (var h = 0; h < n; h++)
                o.push(
                  '<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' +
                    ...
                    i +
                    "px;background-color:" +
                    (e.isDark(_, h) ? t.colorDark : t.colorLight) +
                    ';"></td>'
                );
              o.push("</tr>");
            }
  ...
  ((QRCode = function (e, t) {
    if (
      ...
      for (var r in t) this._htOption[r] = t[r];
    ...
    (this._oQRCode = new h(
      r(e, this._htOption.correctLevel),
...
function _a2(e, t, r) {
  (this._bm = e),
    ...
    this.__defineGetter__("_fo", function () {
      for (var e = 0, t = 0; t < this._do.length; t++) e += this._do[t].length;
      return e;
    }),
    (this._fb = function () {
      return this._do;
...
function _a3(e, t, r, n, a, i) {
  (this._bs = e), (this._ar = t), (this._do = new Array(r, n, a, i));
  ...
  (this._br = o),
    ...
    (this._aq = function () {
      var e = this._cr,
        t = new _ac(e);
      t._bq(0, 0, 9, 9), t._bq(e - 8, 0, 8, 9), t._bq(0, e - 8, 9, 8);
      for (var r = this._ar.length, n = 0; n < r; n++)
        for (var a = this._ar[n] - 2, i = 0; i < r; i++)
          (0 == n && (0 == i || i == r - 1)) ||
            (n == r - 1 && 0 == i) ||
            t._bq(this._ar[i] - 2, a, 5, 5);
      return (
        t._bq(6, 9, 1, e - 17),
        t._bq(9, 6, e - 17, 1),
        6 < this._bs && (t._bq(e - 11, 0, 3, 6), t._bq(0, e - 11, 6, 3)),
        t
      );
    }),
    (this._bu = function (e) {
    ...
    (this._ad = function (e) {
      for (
        ...
        var w = e[d],
          f = e[d + 1],
          u = a * w + _ * f + c;
        (e[d] = (r * w + i * f + h) / u), (e[d + 1] = (n * w + o * f + s) / u);
      }
    }),
  ...
  (this.image = e),
    ...
    (this._bh = function (e, t, r, n) {
      ...
      r < 0
        ? ((i = e / (e - r)), (r = 0))
        : r >= qrcode.width &&
          ((i = (qrcode.width - 1 - e) / (r - e)), (r = qrcode.width - 1));
      (n = Math.floor(t - (n - t) * i)), (i = 1);
      return (
        n < 0
          ? ((i = t / (t - n)), (n = 0))
          : n >= qrcode.height &&
            ((i = (qrcode.height - 1 - t) / (n - t)), (n = qrcode.height - 1)),
    ...
    (this._bx = function (e, t, r, n) {
      var a =
        7 +
        ((Math.round(this.distance(e, t) / n) +
          Math.round(this.distance(e, r) / n)) >>
          1);
      switch (3 & a) {
        case 0:
          a++;
    ...
    (this._bl = function (e, t, r, n) {
      ...
      if (n - i < 3 * e) throw "Error";
      (t = Math.max(0, r - a)), (a = Math.min(qrcode.height - 1, r + a));
      ...
      if (0 < o._as.length)
        for (
          var o = r.X - t.X + n.X,
            h = r.Y - t.Y + n.Y,
            e = 1 - 3 / e,
            s = Math.floor(t.X + e * (o - t.X)),
            c = Math.floor(t.Y + e * (h - t.Y)),
            d = 4;
          d <= 16;
          d <<= 1
        ) {
...
(_aa._ab = function (e, t) {
  for (
    var r = qrcode.width, n = qrcode.height, a = !0, i = 0;
    i < t.length && a;
    i += 2
  ) {
    var o = Math.floor(t[i]),
      _ = Math.floor(t[i + 1]);
    if (o < -1 || r < o || _ < -1 || n < _) throw "Error._ab ";
    (a = !1),
      -1 == o ? (a = !(t[i] = 0)) : o == r && ((t[i] = r - 1), (a = !0)),
      -1 == _
        ? (a = !(t[i + 1] = 0))
        : _ == n && ((t[i + 1] = n - 1), (a = !0));
  }
  ...
  for (i = t.length - 2; 0 <= i && a; i -= 2) {
    (o = Math.floor(t[i])), (_ = Math.floor(t[i + 1]));
    if (o < -1 || r < o || _ < -1 || n < _) throw "Error._ab ";
    (a = !1),
      -1 == o ? (a = !(t[i] = 0)) : o == r && ((t[i] = r - 1), (a = !0)),
      -1 == _
  ...
  (_aa._af = function (e, t, r) {
    for (var n = new _ac(t), a = new Array(t << 1), i = 0; i < t; i++) {
      for (var o = a.length, _ = i + 0.5, h = 0; h < o; h += 2)
        (a[h] = 0.5 + (h >> 1)), (a[h + 1] = _);
      r._ad(a), _aa._ab(e, a);
      try {
        for (h = 0; h < o; h += 2)
          e[Math.floor(a[h]) + qrcode.width * Math.floor(a[h + 1])] &&
            n._dq(h >> 1, i);
      } catch (e) {
        throw "Error._ab";
      }
  ...
  (_a3.VERSIONS = _ay()),
  (_a3._av = function (e) {
    if (e < 1 || 40 < e) throw "bad arguments";
    return _a3.VERSIONS[e - 1];
  }),
  (_a3._at = function (e) {
    if (e % 4 != 1) throw "Error _at";
    try {
...
(_ax._gj = function (e, t) {
  ...
  (_cg.forBits = function (e) {
    if (e < 0 || e >= FOR_BITS.length) throw "bad arguments";
    return FOR_BITS[e];
  });
var L = new _cg(0, 1, "L"),
  M = new _cg(1, 0, "M"),
...
function _cl(e) {
  ...
  (this._au = e),
    ...
    (this._cm = function () {
      ...
      for (var e = 0, t = 0; t < 6; t++) e = this._dk(t, 8, e);
      (e = this._dk(7, 8, e)), (e = this._dk(8, 8, e)), (e = this._dk(8, 7, e));
      for (var r = 5; 0 <= r; r--) e = this._dk(8, r, e);
      if (((this._co = _ax._ci(e)), null != this._co)) return this._co;
      for (var n = this._au.Dimension, e = 0, a = n - 8, t = n - 1; a <= t; t--)
        e = this._dk(t, 8, e);
      for (r = n - 7; r < n; r++) e = this._dk(8, r, e);
      if (((this._co = _ax._ci(e)), null != this._co)) return this._co;
      throw "Error _cm";
    }),
    (this._cq = function () {
      ...
      var e = this._au.Dimension,
        t = (e - 17) >> 2;
      if (t <= 6) return _a3._av(t);
      for (var r = 0, n = e - 11, a = 5; 0 <= a; a--)
        for (var i = e - 9; n <= i; i--) r = this._dk(i, a, r);
      if (((this._cp = _a3._aw(r)), null != this._cp && this._cp._cr == e))
        return this._cp;
      r = 0;
      for (i = 5; 0 <= i; i--)
        for (a = e - 9; n <= a; a--) r = this._dk(i, a, r);
      if (((this._cp = _a3._aw(r)), null != this._cp && this._cp._cr == e))
        return this._cp;
      throw "Error _cq";
    }),
    (this._gk = function () {
      ...
      if (o != t._dp) throw "Error _gk";
      return i;
    });
}
_dl._gn = function (e, t, r) {
  if (e.length != t._dp) throw "bad arguments";
  ...
  for (var f = _[0]._dw.length, u = _.length - 1; 0 <= u; ) {
    if (_[u]._dw.length == f) break;
    u--;
  }
  u++;
  for (var l = f - n._bo, g = 0, o = 0; o < l; o++)
    for (s = 0; s < h; s++) _[s]._dw[o] = e[g++];
  for (s = u; s < h; s++) _[s]._dw[l] = e[g++];
...
function _fg() {
  (this._dj = function (e, t) {
    for (var r = 0; r < t; r++)
      for (var n = 0; n < t; n++) this._fw(r, n) && e.flip(n, r);
  }),
...
function _db(e) {
  (this._fa = e),
    (this.decode = function (e, t) {
      for (
        var r = new _bp(this._fa, e), n = new Array(t), a = 0;
        a < n.length;
        a++
      )
        n[a] = 0;
      ...
      if (!i)
        for (
          var _ = new _bp(this._fa, n),
            h = this._eb(this._fa._ba(t, 1), _, t),
            _ = h[0],
            h = h[1],
            s = this._ey(_),
            c = this._di(h, s, !1),
    ...
    (this._eb = function (e, t, r) {
      ...
      for (
        ...
        var c = a,
          ...
          o = _,
          h = s;
        if ((a = i).Zero) throw "r_{i-1} was zero";
        i = c;
        for (
          var f = this._fa.Zero, c = a._ex(a._ec), u = this._fa.inverse(c);
          i._ec >= a._ec && !i.Zero;
          ...
          var l = i._ec - a._ec,
            ...
            i = i._bd(a._dc(l, g));
        (_ = f.multiply1(o)._bd(d)), (s = f.multiply1(h)._bd(w));
      }
      e = s._ex(0);
      if (0 == e) throw "ReedSolomonException sigmaTilde(0) was zero";
      (t = this._fa.inverse(e)), (e = s.multiply2(t)), (t = i.multiply2(t));
      return new Array(e, t);
    }),
    (this._ey = function (e) {
      var t = e._ec;
      if (1 == t) return new Array(e._ex(1));
      for (var r = new Array(t), n = 0, a = 1; a < 256 && n < t; a++)
        0 == e.evaluateAt(a) && ((r[n] = this._fa.inverse(a)), n++);
    ...
    (this._di = function (e, t, r) {
      for (var n = t.length, a = new Array(n), i = 0; i < n; i++) {
        for (var o = this._fa.inverse(t[i]), _ = 1, h = 0; h < n; h++)
          i != h &&
            (_ = this._fa.multiply(_, _az._bd(1, this._fa.multiply(t[h], o))));
...
function _bp(_, e) {
  if (null == e || 0 == e.length) throw "bad arguments";
  this._fa = _;
  var t = e.length;
  if (1 < t && 0 == e[0]) {
    for (var r = 1; r < t && 0 == e[r]; ) r++;
    if (r == t) this._dd = _.Zero._dd;
    else {
      this._dd = new Array(t - r);
      for (var n = 0; n < this._dd.length; n++) this._dd[n] = 0;
      for (var a = 0; a < this._dd.length; a++) this._dd[a] = e[r + a];
    }
  } else this._dd = e;
  this.__defineGetter__("Zero", function () {
    ...
    (this.evaluateAt = function (e) {
      if (0 == e) return this._ex(0);
      var t = this._dd.length;
      if (1 == e) {
        for (var r = 0, n = 0; n < t; n++) r = _az._bd(r, this._dd[n]);
        return r;
      }
    ...
    (this._bd = function (e) {
      if (this._fa != e._fa) throw "GF256Polys do not have same _az _fa";
      if (this.Zero) return e;
      if (e.Zero) return this;
      var t = this._dd,
        r = e._dd;
      t.length > r.length && ((e = t), (t = r), (r = e));
      for (
        var n = new Array(r.length), a = r.length - t.length, i = 0;
        i < a;
        i++
      )
        n[i] = r[i];
      for (var o = a; o < r.length; o++) n[o] = _az._bd(t[o - a], r[o]);
      return new _bp(_, n);
    }),
    (this.multiply1 = function (e) {
      if (this._fa != e._fa) throw "GF256Polys do not have same _az _fa";
      if (this.Zero || e.Zero) return this._fa.Zero;
      for (
        var t = this._dd,
          r = t.length,
          n = e._dd,
    ...
    (this._dc = function (e, t) {
      if (e < 0) throw "bad arguments";
      if (0 == t) return this._fa.Zero;
      for (
        var r = this._dd.length, n = new Array(r + e), a = 0;
        a < n.length;
        a++
      )
        n[a] = 0;
      for (a = 0; a < r; a++) n[a] = this._fa.multiply(this._dd[a], t);
...
function _az(e) {
  (this._gh = new Array(256)), (this._gi = new Array(256));
  for (var t = 1, r = 0; r < 256; r++)
    (this._gh[r] = t), 256 <= (t <<= 1) && (t ^= e);
  for (r = 0; r < 255; r++) this._gi[this._gh[r]] = r;
  var n = new Array(1);
  (n[0] = 0), (this.zero = new _bp(this, new Array(n)));
  n = new Array(1);
  (n[0] = 1),
    ...
    (this._ba = function (e, t) {
      ...
      return (r[0] = t), new _bp(this, r);
    }),
    (this.exp = function (e) {
      return this._gh[e];
    }),
    (this.log = function (e) {
      if (0 == e) throw "bad arguments";
      return this._gi[e];
    }),
    ...
    (this.multiply = function (e, t) {
      return 0 == e || 0 == t
        ...
        : 1 == t
        ? e
        : this._gh[(this._gi[e] + this._gi[t]) % 255];
    });
}
(_dx._gl = function (e) {
  if (e < 0 || 7 < e) throw "bad arguments";
  return _dx._dy[e];
}),
  (_dx._dy = new Array(
    new _fg(),
...
(qrcode.imagedata = null),
  ...
  (qrcode.vidSuccess = function (e) {
    (qrcode.localstream = e),
      qrcode.webkit
        ? (qrcode.video.src = window.webkitURL.createObjectURL(e))
        : qrcode.moz
        ? ((qrcode.video.mozSrcObject = e), qrcode.video.play())
        : (qrcode.video.src = e),
      (qrcode.gUM = !0),
      ...
      try {
        navigator.mediaDevices.enumerateDevices().then(function (e) {
          e.forEach(function (e) {
            console.log("deb1"),
              "videoinput" === e.kind &&
                -1 < e.label.toLowerCase().search("back") &&
                (r = [
                  {
                    sourceId: e.deviceId,
                  },
  ...
  (qrcode.decode = function (e) {
    ...
    if (0 == arguments.length)
      return (
        (r = qrcode.canvas_qr2
          ? ((t = qrcode.canvas_qr2), qrcode.qrcontext2)
          : (t = document.getElementById("qr-canvas")).getContext("2d")),
    ...
    (i.crossOrigin = "Anonymous"),
      (i.onload = function () {
        ...
        null != e &&
          ((t = e.getContext("2d")).clearRect(0, 0, 320, 240),
        ...
        var t,
          ...
          a = i.height,
          e = i.width;
        i.width * i.height > qrcode.maxImgSize &&
          (e =
            (t = i.width / i.height) * (a = Math.sqrt(qrcode.maxImgSize / t))),
          (r.width = e),
          (r.height = a),
    ...
    if (qrcode.debug) {
      for (var n = 0; n < qrcode.height; n++)
        for (var a = 0; a < qrcode.width; a++) {
          ...
          (qrcode.imagedata.data[i] = (r[a + n * qrcode.width], 0)),
            (qrcode.imagedata.data[i + 1] = (r[a + n * qrcode.width], 0)),
    ...
    if (qrcode.debug) {
      for (n = 0; n < o.bits.Height; n++)
        for (a = 0; a < o.bits.Width; a++) {
          ...
          (qrcode.imagedata.data[i] = (o.bits._ds(a, n), 0)),
            (qrcode.imagedata.data[i + 1] = (o.bits._ds(a, n), 0)),
            (qrcode.imagedata.data[i + 2] = o.bits._ds(a, n) ? 255 : 0);
        }
      e.putImageData(qrcode.imagedata, 0, 0);
    }
    for (
      var _ = Decoder.decode(o.bits).DataByte, h = "", s = 0;
      s < _.length;
      s++
    )
      for (var c = 0; c < _[s].length; c++) h += String.fromCharCode(_[s][c]);
    t = new Date().getTime() - t;
    return console.log(t), qrcode.decode_utf8(h);
  }),
  (qrcode.getPixel = function (e, t) {
    ...
    return (
      (33 * qrcode.imagedata.data[t] +
        34 * qrcode.imagedata.data[1 + t] +
        33 * qrcode.imagedata.data[2 + t]) /
      100
    );
  }),
  ...
  (qrcode._em = function (e) {
    for (
      ...
      n[a] = new Array(4);
      for (var i = 0; i < 4; i++) n[a][i] = new Array(0, 0);
    }
    for (var o = 0; o < 4; o++)
      for (var _ = 0; _ < 4; _++) {
        n[_][o][0] = 255;
    ...
    for (var d = new Array(4), w = 0; w < 4; w++) d[w] = new Array(4);
    for (o = 0; o < 4; o++)
      for (_ = 0; _ < 4; _++)
  ...
  (qrcode.grayScaleToBitmap = function (e) {
    for (
      var t = qrcode._em(e),
        ...
        a = Math.floor(qrcode.height / r),
        i = new ArrayBuffer(qrcode.width * qrcode.height),
        o = new Uint8Array(i),
        _ = 0;
      _ < r;
      _++
      ...
      for (var h = 0; h < r; h++)
        for (var s = 0; s < a; s++)
          for (var c = 0; c < n; c++)
            o[n * h + c + (a * _ + s) * qrcode.width] =
              e[n * h + c + (a * _ + s) * qrcode.width] < t[h][_];
    return o;
  }),
  ...
  (this.image = null),
    ...
    (this._ao = function (e) {
      ...
      var a = Math.floor((t << _el) / 7),
        i = Math.floor(a / 2);
      return (
        Math.abs(a - (e[0] << _el)) < i &&
        Math.abs(a - (e[1] << _el)) < i &&
        Math.abs(3 * a - (e[2] << _el)) < 3 * i &&
        Math.abs(a - (e[3] << _el)) < i &&
        Math.abs(a - (e[4] << _el)) < i
      );
    }),
    ...
    (this._ap = function (e, t, r, n) {
      for (
        var a = this.image, i = qrcode.height, o = this._da, _ = e;
        0 <= _ && a[t + _ * qrcode.width];

      )
        o[2]++, _--;
      if (_ < 0) return NaN;
      for (; 0 <= _ && !a[t + _ * qrcode.width] && o[1] <= r; ) o[1]++, _--;
      if (_ < 0 || o[1] > r) return NaN;
      for (; 0 <= _ && a[t + _ * qrcode.width] && o[0] <= r; ) o[0]++, _--;
      if (o[0] > r) return NaN;
      for (_ = e + 1; _ < i && a[t + _ * qrcode.width]; ) o[2]++, _++;
      if (_ == i) return NaN;
      for (; _ < i && !a[t + _ * qrcode.width] && o[3] < r; ) o[3]++, _++;
      if (_ == i || o[3] >= r) return NaN;
      for (; _ < i && a[t + _ * qrcode.width] && o[4] < r; ) o[4]++, _++;
      if (o[4] >= r) return NaN;
      e = o[0] + o[1] + o[2] + o[3] + o[4];
      return !(5 * Math.abs(e - n) >= 2 * n) && this._ao(o)
        ? this._an(o, _)
        : NaN;
    }),
    (this._ej = function (e, t, r, n) {
      for (
        var a = this.image, i = qrcode.width, o = this._da, _ = e;
        0 <= _ && a[_ + t * qrcode.width];

      )
        o[2]++, _--;
      if (_ < 0) return NaN;
      for (; 0 <= _ && !a[_ + t * qrcode.width] && o[1] <= r; ) o[1]++, _--;
      if (_ < 0 || o[1] > r) return NaN;
      for (; 0 <= _ && a[_ + t * qrcode.width] && o[0] <= r; ) o[0]++, _--;
      if (o[0] > r) return NaN;
      for (_ = e + 1; _ < i && a[_ + t * qrcode.width]; ) o[2]++, _++;
      if (_ == i) return NaN;
      for (; _ < i && !a[_ + t * qrcode.width] && o[3] < r; ) o[3]++, _++;
      if (_ == i || o[3] >= r) return NaN;
      for (; _ < i && a[_ + t * qrcode.width] && o[4] < r; ) o[4]++, _++;
      if (o[4] >= r) return NaN;
      e = o[0] + o[1] + o[2] + o[3] + o[4];
    ...
    (this._cu = function (e, t, r) {
      ...
      if (
        isNaN(i) ||
        ((a = this._ej(Math.floor(a), Math.floor(i), e[2], n)), isNaN(a))
      )
        return !1;
    ...
    (this._ee = function () {
      ...
      if (3 < e) {
        ...
        this._cv.sort(function (e, t) {
          (t = Math.abs(t._ei - i)), (e = Math.abs(e._ei - i));
          return t < e ? -1 : t == e ? 0 : 1;
        });
        for (
          var o = Math.sqrt(r / e - i * i),
            _ = Math.max(0.2 * i, o),
            n = this._cv.length - 1;
          0 <= n;
          n--
    ...
    (this._cx = function () {
      for (var e = 0, t = 0, r = this._cv.length, n = 0; n < r; n++) {
        var a = this._cv[n];
        a.Count >= _eg && (e++, (t += a._ei));
      }
      if (e < 3) return !1;
      for (var i = t / r, o = 0, n = 0; n < r; n++)
        (a = this._cv[n]), (o += Math.abs(a._ei - i));
      return o <= 0.05 * t;
    }),
    (this._ce = function (e) {
      this.image = e;
      ...
      for (var n = !1, a = new Array(5), i = s - 1; i < t && !n; i += s) {
        ...
        for (var o = (a[4] = 0), _ = 0; _ < r; _++)
          if (e[_ + i * qrcode.width]) 1 == (1 & o) && o++, a[o]++;
          else if (0 == (1 & o))
            if (4 == o)
              if (this._ao(a)) {
                if (this._cu(a, i, _)) {
        ...
        this._ao(a) &&
          this._cu(a, i, r) &&
          ((s = a[0]), this._ge && (n = this._cx()));
      }
      var c = this._ee();
      return qrcode._er(c), new _es(c);
    });
}
function _ai(e, t, r) {
  (this.x = e),
  ...
  (this.image = c),
    ...
    (this._ap = function (e, t, r, n) {
      ...
      for (_ = e + 1; _ < i && a[t + _ * qrcode.width] && o[1] <= r; )
        o[1]++, _++;
      if (_ == i || o[1] > r) return NaN;
      for (; _ < i && !a[t + _ * qrcode.width] && o[2] <= r; ) o[2]++, _++;
      if (o[2] > r) return NaN;
      e = o[0] + o[1] + o[2];
      return !(5 * Math.abs(e - n) >= 2 * n) && this._ao(o)
        ? this._an(o, _)
    ...
    (this._cu = function (e, t, r) {
      ...
      if (!isNaN(i)) {
        for (
          var o = (e[0] + e[1] + e[2]) / 3, _ = this._cv.length, h = 0;
          h < _;
          h++
        )
          if (this._cv[h]._ev(o, i, a)) return new _ai(a, i, o);
        e = new _ai(a, i, o);
        this._cv.push(e), null != this._am && this._am._ep(e);
      }
      return null;
    }),
    (this.find = function () {
      for (
        ...
        (a[0] = 0), (a[1] = 0), (a[2] = 0);
        for (var _ = e; _ < r && !c[_ + qrcode.width * o]; ) _++;
        for (var h, s = 0; _ < r; ) {
          if (c[_ + o * qrcode.width])
            if (1 == s) a[s]++;
            else if (2 == s) {
              if (this._ao(a)) if (null != (h = this._cu(a, o, _))) return h;
              (a[0] = a[2]), (a[1] = 1), (a[2] = 0), (s = 1);
            } else a[++s]++;
          else 1 == s && s++, a[s]++;
          _++;
        }
        if (this._ao(a)) if (null != (h = this._cu(a, o, r))) return h;
      }
...
function QRCodeDataBlockReader(e, t, r) {
  (this._ed = 0),
    ...
    t <= 9
      ...
      : 27 <= t && t <= 40 && (this.dataLengthMode = 2),
    (this._gd = function (e) {
      var t = 0;
      if (e < this._cw + 1) {
      ...
      if (e < this._cw + 1 + 8) {
        for (var a = 0, n = 0; n < this._cw + 1; n++) a += 1 << n;
        return (
          (t = (this.blocks[this._ed] & a) << (e - (this._cw + 1))),
          this._ed++,
      ...
      if (e < this._cw + 1 + 16) {
        for (var a = 0, i = 0, n = 0; n < this._cw + 1; n++) a += 1 << n;
        var o = (this.blocks[this._ed] & a) << (e - (this._cw + 1));
        this._ed++;
        var _ = this.blocks[this._ed] << (e - (this._cw + 1 + 8));
        this._ed++;
        for (n = 0; n < e - (this._cw + 1 + 8); n++) i += 1 << n;
        i <<= 8 - (e - (this._cw + 1 + 8));
        t =
          o +
          _ +
          ((this.blocks[this._ed] & i) >> (8 - (e - (this._cw + 1 + 8))));
        return (
          (this._cw = this._cw - ((e - 8) % 8)),
          this._cw < 0 && (this._cw = 8 + this._cw),
          t
        );
      }
    ...
    (this.getFigureString = function (e) {
      for (
        var t = e, r = 0, n = "";
        3 <= t
          ? ((r = this._gd(10)) < 100 && (n += "0"),
            r < 10 && (n += "0"),
            (t -= 3))
          : 2 == t
          ? ((r = this._gd(7)) < 10 && (n += "0"), (t -= 2))
          : 1 == t && ((r = this._gd(4)), --t),
          (n += r),
          0 < t;
    ...
    (this.get8bitByteArray = function (e) {
      for (
        var t, r = e, n = new Array();
        (t = this._gd(8)), n.push(t), r--, 0 < r;
    ...
    (this.getKanjiString = function (e) {
      ...
      } while (((n += String.fromCharCode(i)), 0 < --r));
      return n;
    }),
      ...
      for (var e = new Array(); ; ) {
        ...
        if (7 == t) var r = this.parseECIValue();
          ...
          switch (t) {
            case 1:
              for (
                var a = this.getFigureString(n), i = new Array(a.length), o = 0;
                o < a.length;
                o++
              )
                i[o] = a.charCodeAt(o);
            ...
            case 2:
              for (
                a = this.getRomanAndFigureString(n),
...
var gCtx = null,
  ...
  moz = !1,
  imghtml =
    '<div id="qrfile"><canvas id="out-canvas" width="314" height="250"></canvas><div id="imghelp"><small>Drag and Drop a QRCode here<br>or Select a file<input type="file" onchange="handleFiles(this.files)"/></small></div></div>';
...
function read(e) {
  ...
  (0 !== e.indexOf("http://") && 0 !== e.indexOf("https://")) ||
    (t += "<a target='_blank' href='" + e + "'>" + e + "</a><br>"),
...
function success(e) {
  (gUM = !0), setTimeout(captureToCanvas, 500);
}
const error = (e) => (gUM = !1);
function load() {
  isCanvasSupported() && window.File && window.FileReader
    ? (initCanvas(800, 600),
      ...
      setimg())
    : ((document.getElementById("qr-mainbody").style.display = "inline"),
      (document.getElementById("qr-mainbody").innerHTML =
...
function setimg() {
  ...
  (document.getElementById("qr-result").innerHTML = ""),
    2 != stype &&
      ((document.getElementById("qr-outdiv").innerHTML = imghtml),
      (e = document.getElementById("qrfile")).addEventListener(
        "dragenter",
        dragenter,
        !1
      ),
